...
class FirebaseCollectionReactive<T extends FirebaseType>{
  ...
  observable = Observable(ref.snapshots()).scan((List<T> list,QuerySnapshot snapshot, b) {
    ...
    snapshot.documentChanges.forEach((change) {
      ...
      switch(change.type){
        case DocumentChangeType.added:
          ...
          list.removeWhere((element) => element.uid == change.document.documentID);
        ...
        case DocumentChangeType.modified:
          ...
          list.where((element) => element.uid == change.document.documentID).forEach((element) => element.mapFrom(change.document.data));
