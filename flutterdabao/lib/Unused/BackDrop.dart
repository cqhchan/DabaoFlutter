...
//     _handleFilter(flag) {
//       if (flag.value == true) {
//         return ImageFilter.blur(sigmaX: 3.0, sigmaY: 3.0);
//       } else {
//         return ImageFilter.blur(sigmaX: 0.0, sigmaY: 0.0);
//       }
//     }

//     //Darken the backpanel
//     _handleFilterColour(flag) {
//       if (flag.value == true) {
//         return BoxDecoration(color: Colors.black.withOpacity(0.2));
//       } else {
//         return BoxDecoration(color: Colors.black.withOpacity(0.0));
//       }
//     }

//     return Container(
//       child: BackdropFilter(
//         filter: _handleFilter(widget.panelVisible),
//         child: Container(
//           decoration: _handleFilterColour(widget.panelVisible),
//         ),
//       ),
//     );
//   }
